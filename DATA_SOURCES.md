...
| **RainViewer** (`weather-maps.json` + radar tiles) | Live precipitation radar overlay (optional layer, keyless) | [RainViewer API terms](https://www.rainviewer.com/api.html) (free tier, non-commercial; attribution required while displayed) | "Weather radar: RainViewer" — registered with the layer |

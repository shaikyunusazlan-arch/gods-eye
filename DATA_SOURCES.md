...
| **Stadt Warendorf webcam** | CCTV frames, Marktplatz / Historisches Rathaus (`config/cctv_sources.warendorf.json`) | Publicly published municipal webcam; **no stated open licence** — courtesy attribution, frames fetched at runtime and never redistributed | "Stadt Warendorf — webcam.warendorf.de"; mount and heading derived from OSM geometry, "© OpenStreetMap contributors" (ODbL) |
| **Kreis Warendorf webcams** | CCTV frames, Kfz-Zulassungsstellen Warendorf and Beckum (`config/cctv_sources.warendorf.json`) | Publicly published municipal webcams; **no stated open licence** — courtesy attribution, frames fetched at runtime and never redistributed | "Kreis Warendorf — kreis-warendorf.de"; positions derived from OSM building geometry, "© OpenStreetMap contributors" (ODbL) |
